...
|--------------------|------------------------------------|----------------------------------------|
|Nathalia Amorim     | agilizar marcações de consulta     | otimizar sua rotina                    |
|Lucas Jhony         | encontrar mais produtos online     | comprar online com mais eficiência     |
|Gabriel D'Angelo    | tirar dúvidas e pesquisar          | obter consultoria ao veterinário online|
|Ana Carolina        | Maior diversificação de produtos   | obter produtos novos e inovadores pet's|
|Gabriela Mariz      | uma aplicação moderna,leve e rapida| obter o melhor desempenho dos serviços |
|Administrador       | um serviço integrado de delivery   | receber seus produtos sem sair de casa |
...
|RF-010| Registrar e Logar no Sistema Web com usuário e senha | ALTA |
